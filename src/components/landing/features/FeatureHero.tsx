...
export const FeatureHero: FC<FeatureHeroProps> = ({ className, title, description, image, cta, secondaryCta, ...props }) => {
  return (
    <div className={cn("relative mx-auto flex max-w-7xl flex-col justify-center px-4 pt-20 sm:px-6 sm:pt-36 lg:px-0", className)} {...props}>
